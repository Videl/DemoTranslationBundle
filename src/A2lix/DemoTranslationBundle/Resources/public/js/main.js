...
a2lix_libJS.collectionModule = (function(com) {
    ...
    var addEntry = function($elt)
    {
        var maxCollectionEntries = $elt.parents('.a2lix_collection').data('collection-nb'),
            $collectionEntryTpl = $($elt.data('collection-tpl')),
            $newDiv = $($collectionEntryTpl.html().replace(/__name__/g, maxCollectionEntries++));
